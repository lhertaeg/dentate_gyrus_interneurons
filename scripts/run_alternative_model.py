...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 21 09:50:58 2025
...
def generate_and_save_data():
    ...
    # define model
    total_weights = np.array([[0,0,1.5],[0,0,0],[1.5,0,0.5]]) ########## !!!!!!!!!!
    ...
    results = model.simulate(EC_input2E=EC_input2E, EC_input2PVFF=EC_input2PVFF, T=T_total, dt=default.dt, 
                             eta=default.eta, w_max=default.w_max, plasticity=True, alternative_flag=1) ####### !!!!

    # save and return data    
    data = {"results": results, "EC_input2E": EC_input2E, "EC_input2PVFF": EC_input2PVFF}
    
    save_path = os.path.join("..", "results", "data_alternative_model.pkl")
...
def main(rerun=False):
    ...
    load_path = os.path.join("..", "results", "data_alternative_model.pkl")
